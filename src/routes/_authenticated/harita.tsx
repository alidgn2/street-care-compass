      ...
      <div className="relative" style={{ height: "calc(100vh - 170px)" }}>
        ...
        <div className="pointer-events-none absolute bottom-4 right-4 z-[1000] flex flex-col gap-3">
          ...
          <button onClick={quickFeed}
            ...
            <Plus className="h-5 w-5" /> Besleme bildir
          </button>
        </div>
        ...
        <div className="pointer-events-none absolute left-4 top-4 z-[1000] flex flex-wrap gap-2">
          {[
            ...
            <span key={l.label} className="flex items-center gap-1.5 rounded-full bg-card/95 px-3 py-1 text-xs font-medium shadow backdrop-blur">
